Calagator.setup do |config|
  # Site name
  config.title = 'PDX Activist'

  # Site tagline
  config.tagline = 'A Portland Activist Calendar'

  # Site URL with trailing slash
  config.url = 'https://pdxactivist.org/'

  # Email address of administrator that will get exception notifications
  # and requests for assistance from users:
  config.administrator_email = 'jacob+pdxactivist@technosorcery.net'
